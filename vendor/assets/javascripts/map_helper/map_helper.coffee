...
class window.MapHelper
  ...
  @showMap = (canvas, options) ->
    ...
    # Options
    mapHeight        = @optionValue( options.mapHeight,        750 )
    ...
    disableDefaultUI = @optionValue( options.disableDefaultUI, false )
  ...
  @searchShowMap = (canvas, map, options) ->
